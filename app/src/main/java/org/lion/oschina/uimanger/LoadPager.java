package org.lion.oschina.uimanger;
...
public abstract class LoadPager extends FrameLayout
{
    ...
    private void initLoadPager()
    {
        ...
        if (mLoadingView == null)
        {
            ...
            mLoadingView = View.inflate(OsChinaApp.context, R.layout.page_loading, null);
        }
        // 添加布局
        ...
        if (mErrorView == null)
        {
            ...
            mErrorView = View.inflate(OsChinaApp.context, R.layout.page_error, null);

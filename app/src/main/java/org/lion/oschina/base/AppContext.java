...
import org.lion.oschina.general.utils.GeneralUtils;
...
public class AppContext extends BaseApplication {
    ...
    public void onCreate() {
        ...
        mContext = context;
        mHandler=myHandler;
        ImageLoader.getInstance().init( ImageLoaderConfiguration.createDefault(OsChinaApp.context));

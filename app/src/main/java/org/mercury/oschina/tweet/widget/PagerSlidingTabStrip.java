...
package org.mercury.oschina.tweet.widget;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = 0xFF006BCE;
	...
	private int tabSelectedTextColor = 0xFF0B9A27;
	...
	private void updateTabTextColor(int position) {
		for (int i = 0; i < tabCount; i++) {
            View v = tabsContainer.getChildAt(i);
            ((TextView)v).setTextColor(position == i ? tabSelectedTextColor : tabTextColor);
        }
	}

...
public class Constants {
    ...
    public static String API_URL = "http://www.oschina.net/";

    public static String SP_VISITED_NEWS = "SP_VISITED_NEWS";
    public static String VISITED_NEWS_MAP = "VISITED_NEWS_MAP";

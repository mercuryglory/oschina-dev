 ...
 * @更新描述 ${TODU}
 */
public class CodeFragment extends BasicFragment implements AdapterView.OnItemClickListener {
    ...
    protected Object loadDataThread() {
     //  new GetDatasForCollectActivity(OschinaUri.COLLECT_5,mPtrlistView).sendRequestData();

        OkHttpUtils
                .get()
                .url(OschinaUri.COLLECT_5)
